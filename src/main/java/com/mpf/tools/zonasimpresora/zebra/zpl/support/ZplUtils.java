...
public class ZplUtils {
    ...
    /**
     * Fonction called by zplCommand to cast variable object and ajust for zpl
     * code
     * 
     * @param object
     */
     ...
     * 
     * Fonts and PPP are not all supported. Please complete this method or use
     * dot in yous params
     * 
     * @param zebraFont
     * @param fontSize
	...
	if (ZebraFont.ZEBRA_ZERO.equals(zebraFont) && ZebraPPP.DPI_300.equals(zebraPPP)) {
	    // We use ratio to converted (based on ratio used by Zebra Designer
	    // Tools)
	    array[0] = Math.round(fontSize * 4.16F);// Heigth
	    array[1] = Math.round(fontSize * 4.06F);// With
	} else {
	    throw new UnsupportedOperationException(
		    "This PPP and this font are not yet supported. Please use ZebraAFontElement.");
	}
	return array;
    }
    ...
    /**
     * Function used to converted ASCII >127 in \hexaCode accepted by ZPL
     * language
     * 
     * @param str
     *            str
